...
public class KeycloakSmsPhoneNumberCredentialProvider implements CredentialProvider, CredentialInputValidator, CredentialInputUpdater, OnUserCache {
    public static final String MOBILE_NUMBER = "phoneNumber";
    public static final String CACHE_KEY = KeycloakSmsPhoneNumberCredentialProvider.class.getName() + "." + MOBILE_NUMBER;

    protected KeycloakSession session;

    public KeycloakSmsPhoneNumberCredentialProvider(KeycloakSession session) {
